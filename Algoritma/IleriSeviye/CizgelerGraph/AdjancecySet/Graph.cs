...
namespace Programlama.IleriAlgoritma.Graph
{
    public class Graph<T> : IGraph<T> where T : notnull
    {
        ...
        private Dictionary<T, GraphVertex> vertices;
        ...
        public void AddVertex(T key)
        {
            ...
            var newVertex = new GraphVertex(key);
        ...
        public void AddEdge(T source, T dest)
        {
            ...
            if (vertices[source].Edges.Contains(vertices[dest]) || vertices[dest].Edges.Contains(vertices[source])) throw new Exception("The edge has been already defined!");
        ...
        public void RemoveVertex(T key)
        {
            ...
            {
                item.Edges.Remove(vertices[key]);
            }
        ...
        private class GraphVertex : IGraphVertex<T>
        {
            public T Key { get; set; }
            public HashSet<GraphVertex> Edges { get; private set; }

            public GraphVertex(T key)
            {
                this.Key = key;
                this.Edges = new HashSet<GraphVertex>(); // constructor'da not-null değer atandı
            }
